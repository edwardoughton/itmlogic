            ...
            output.append(
                {
                    ...
                    "propagation_loss_dB": FS[JD]
                    + avar1,  # Add in the adjustment for this level
                }
            )
...
if __name__ == "__main__":
    ...
    transmitter = {
        "type": "Feature",
        "geometry": {"type": "Point", "coordinates": (26.9976, -3.5409)},
        "properties": {"id": "Example radio transmitter"},
    }
