...
if __name__ == "__main__":
    ...
    transmitter = {
        "type": "Feature",
        "geometry": {"type": "Point", "coordinates": (26.676, -3.513)},
        "properties": {"id": "A"},
    }

    receiver = {
        "type": "Feature",
        "geometry": {"type": "Point", "coordinates": (27.594, -3.514)},
        "properties": {"id": "B"},
    }
    ...
    schema = {"geometry": "Point", "properties": {"elevation": "float"}}

    crs = from_epsg(4326)
    with fiona.open(
        "data/processed/shapes/p2p_2tiles.shp",
        "w",
