...
def avar(zzt, zzl, zzc, prop):
    ...
    bzd1 = [1.282, 2.161, 1.282, 20.0, 1.282, 1.282, 1.282]
    ...
    if prop["lvar"] > 0:
        ...
        prop["vmd"] = curv(
            prop["cv1"], prop["cv2"], prop["yv1"], prop["yv2"], prop["yv3"], de
        )

        prop["sgtm"] = (
            curv(
                prop["csm1"], prop["csm2"], prop["ysm1"], prop["ysm2"], prop["ysm3"], de
            )
            * prop["gm"]
        )
        ...
        prop["sgtp"] = (
            curv(
                prop["csp1"], prop["csp2"], prop["ysp1"], prop["ysp2"], prop["ysp3"], de
            )
            * prop["gp"]
        )
        ...
        if prop["wl"]:
            ...
            q = (1 - 0.8 * math.exp(-prop["dist"] / 50e3)) * prop["dh"] * prop["wn"]
            prop["sgl"] = 10 * q / (q + 13)
